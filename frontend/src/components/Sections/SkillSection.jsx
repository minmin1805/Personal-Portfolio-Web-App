  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex flex-row mt-30 "
      >
        <motion.h2
          className={`${
            isDarkMode ? "text-white" : "text-gray-900"
          } text-5xl font-medium lg:text-6xl`}
        >
          Skills &
        </motion.h2>

        <motion.h2 className="text-blue-500 text-5xl font-medium lg:text-6xl">
          Technologies
        </motion.h2>
      </motion.div>
      <motion.p
      ...
      >
        My development ecosystem for creating web applications from idea
        to launch
      </motion.p>
